...
module GenericFold where

import Data.Kind

{-
Curried generic folds, based on a Sum-of-Products f-algebra representation.

Possible without type applications and type families, but much harder to implement
and use.
-}
